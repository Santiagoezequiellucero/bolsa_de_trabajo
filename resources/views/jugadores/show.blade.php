...
<br>
    <div class="text-center">
        ...
        <a href="{{route('jugadores.edit', $jugador)}}" class="navbar-brand">
    ...
    <div class="row justify-content-center align-items-center vh-100 ">
        <div class=" card col-sm-4" style="width: 18rem;">
            <img src="http://localhost/bolsa_de_trabajo/public/storage/{{$jugador->foto_perfil}}" class="card-img-top img-fluid" alt="imagen aqui">
            <div class="card-body ">
