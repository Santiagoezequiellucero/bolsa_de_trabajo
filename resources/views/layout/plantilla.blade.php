...
<head>
    ...
    {{-- favicon --}}
    {{-- script --}}
    <script src="{{ asset('js/app.js') }}" defer></script>W
    {{-- estilos --}}
...
W
        <div class="container col-lg-7 col-md-7 col-12 col-sm-12 d-flex justify-content-center justify-content-start-lg">
            <!-- Links de Navegacion Izquierda -->
            <ul class="navbar-nav">
                <li class="nav-item">
                </li>
                <li class="nav-item d-sm-inline-block">
                    <a href="http://totalges.cl" class="nav-link">Inicio</a>
                </li>
                <li class="nav-item d-sm-inline-block">
                    <a href="http://totalges.cl/escuelaswelcome" class="nav-link">Escuelas</a>
                </li>
                <li class="nav-item d-sm-inline-block">
                    <a href="http://totalges.cl/contacto" class="nav-link">Contacto</a>
                </li>
                <li class="nav-item d-sm-inline-block">
